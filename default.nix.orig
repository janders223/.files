...
in {
  ...
  environment = {
    ...
    etc = {
      ...
      "per-user/.gitconfig".text = import ./config/gitconfig.nix { home = home; vim = config.programs.vim.package; };
      "per-user/.git_template/ctags".text = import ./config/git_template/ctags.nix { ctags = pkgs.ctags; };
      "per-user/.git_template/post-checkout".text = import ./config/git_template/post-checkout.nix;
      "per-user/.git_template/post-commit".text = import ./config/git_template/post-commit.nix;
      "per-user/.git_template/post-merge".text = import ./config/git_template/post-merge.nix;
      "per-user/.git_template/post-rewrite".text = import ./config/git_template/post-rewrite.nix;
  ...
  programs = {
    ...
    tmux = {
      ...
      enableSensible = true;
      enableVim = true;
      tmuxConfig = import ./config/tmux.nix;
    };
    vim = {
